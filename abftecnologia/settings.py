# -*- coding: utf-8 -*-
#
#  abftecnologia/settings.py
#  
#  Copyright 2014 Alisson Barbosa Ferreira <alissonbf@hotmail.com>
#
#  Arquivo de configuração do projeto django, abftecnologia
...
PAGSEGURO_EMAIL_COBRANCA = 'alissonbf@gmail.com' # email de cobrança usado no pagseguro
PAGSEGURO_TOKEN = 'F6684ACAEABF41B2A118679814A40848' # token gerado no sistema de url de retorno do pagseguro
...
STATIC_ROOT = os.path.join(BASE_DIR, 'abftecnologia/static')

STATICFILES_DIRS = (
    ('site',os.path.join(BASE_DIR, 'abftecnologia/sitestatic')),
)
...
MEDIA_ROOT = os.path.join(BASE_DIR, 'abftecnologia/media')

MEDIA_URL = '/media/'

# Localização dos templates do projeto
TEMPLATE_DIRS = (
    os.path.join(BASE_DIR, 'abftecnologia/templates')
)
